...
import type {
  ICreatorCore,
  ICreatorCoreInterface,
} from "../../../../../@manifoldxyz/creator-core-solidity/contracts/core/ICreatorCore";
...
export class ICreatorCore__factory {
  static readonly abi = _abi;
  static createInterface(): ICreatorCoreInterface {
    return new utils.Interface(_abi) as ICreatorCoreInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICreatorCore {
    return new Contract(address, _abi, signerOrProvider) as ICreatorCore;
  }
}
