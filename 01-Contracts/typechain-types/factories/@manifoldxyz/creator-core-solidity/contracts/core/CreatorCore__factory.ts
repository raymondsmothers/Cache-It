...
import type {
  CreatorCore,
  CreatorCoreInterface,
} from "../../../../../@manifoldxyz/creator-core-solidity/contracts/core/CreatorCore";
...
export class CreatorCore__factory {
  static readonly abi = _abi;
  static createInterface(): CreatorCoreInterface {
    return new utils.Interface(_abi) as CreatorCoreInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CreatorCore {
    return new Contract(address, _abi, signerOrProvider) as CreatorCore;
  }
}
