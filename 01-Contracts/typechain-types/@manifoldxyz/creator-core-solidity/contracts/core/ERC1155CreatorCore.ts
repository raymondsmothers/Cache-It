...
export interface ERC1155CreatorCoreInterface extends utils.Interface {
  functions: {
...
export interface ERC1155CreatorCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155CreatorCoreInterface;
